...
//    스프링 프레임워크에서는 생성자 방식으로 의존성 주입하는 것을 권장합니다.
    @Autowired
    public MessageSendService(@Qualifier("emailMessageSender") List<MessageSender> messageSenders) {
...
//    }
    ...
    public void doSendMessage(User user, String message) {
        messageSenders.forEach(messageSender -> messageSender.sendMessage(user, message));
    }
}